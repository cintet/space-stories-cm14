...
ent-RMCWallInvisibleBulletBlocker = блокиратор стен
    .desc = { ent-MarkerBase.desc }
    .suffix = Блокировщик снарядов
ent-RMCWallInvisibleBulletLightBlocker = блокировщик стен
    .desc = { ent-MarkerBase.desc }
    .suffix = Блокировщик снарядов + света
