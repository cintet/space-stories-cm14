...
rmc-job-name-synth = Синтетик КМП США
rmc-job-description-synth = Поддержка и помощь отделам и персоналу КМП США.
rmc-job-prefix-synth = Синт
RMCJobSynthetic = Синтетик
rmc-job-name-synth-colony = Колониальный синтетик
rmc-job-description-synth-colony = Поддержка и помощь персоналу колонии.
