...
rmc-xeno-infection-burst-now-victim = Вы чувствуете, как что-то разрывает ваши внутренности!
rmc-xeno-infection-burst-now-xeno = Мы начинаем вырываться из груди { THE($victim) }!
